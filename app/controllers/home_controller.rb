class HomeController < ApplicationController
  ...
  def find
    ...
    # instancio dos variables que me definiral el punto inicial y final de la funcion consultar()
    @recursive_start = start.yday
    @recursive_end = @last_day_of_query
    # Realizo estas variables en 0, estaran opetando entre si
    @facturas = 0
    @llamadas = 0
  ...
  def consultar(id, s, f)
    ...
    @llamadas = @llamadas + 1
    # Me creo un log en la consula de rails para ir mirando el progreso
    ...
    if consulta_facturas.mb_chars.length == 27
      # Creo unas variables en esta funcion recusiva que me controla un punto de inicio y final
      ...
      # y debo restar 1 por que inicia apartir del dia 0
      num_to_fechas = {
